...
// There are three ranges, four singles, and then there's the rest.
//
//   #  From       To        LUT  Characters
//   1  [0..42]    [255]      #1  invalid input
//   2  [43]       [62]       #1  +
//   3  [44]       [255]      #1  invalid input
//   4  [45]       [62]       #1  -
//   5  [46]       [255]      #1  invalid input
//   6  [47]       [63]       #1  /
//   7  [48..57]   [52..61]   #1  0..9
//   8  [58..63]   [255]      #1  invalid input
//   9  [64]       [255]      #2  invalid input
//  10  [65..90]   [0..25]    #2  A..Z
//  11  [91..94]   [255]      #2  invalid input
//  12  [95]       [63]       #2  _
//  13  [96]       [255]      #2  invalid input
//  14  [97..122]  [26..51]   #2  a..z
//  15  [123..126] [255]      #2  invalid input
// (16) Everything else => invalid input
...
static const uint8_t dec_lut1[] = {
	...
	255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U,
	255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U, 255U,  62U, 255U,  62U, 255U,  63U,
