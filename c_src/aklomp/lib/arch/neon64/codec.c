...
base64_stream_encode_neon64 BASE64_ENC_PARAMS
{
	...
	enc_loop_neon64(&s, &slen, &o, &olen, enc_table_6bit);
	enc_loop_generic_64(&s, &slen, &o, &olen, enc_table_12bit);
